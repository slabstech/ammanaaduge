...
2. log - 100pts
3. authenticate - 100pts
4. timed (n times) - 100pts
5. Provides privilege access to a class that has 4 parameters, based on privileges (high, mid, low, no), gives access to all 4, 3, 2 or 1 params) - 100pts
...
* ### **timed**
Decorator runs for the specified number of times as input integer and calculates average time taken for the function to run.
...
Name: Sahana S Shetty

Email: sahana.shetty998@gmail.com
"""